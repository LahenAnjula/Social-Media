        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col items-center justify-center">
            <div className="w-full h-64 relative">
              <Image
                src="https://images.pexels.com/photos/26653747/pexels-photo-26653747/free-photo-of-the-milky-way-over-the-lake-at-night.jpeg?auto=compress&cs=tinysrgb&w=600&lazy=load"
                alt=""
                fill
            ...
            <h1 className="mt-20 mb-4 text-2xl font-medium">Lahen Anjula</h1>
            <div className="flex items-center justify-center gap-12 mb-4">
              ...
              <div className="flex flex-col items-center">
                ...
                <span className="text-sm">Followera</span>
              </div>
              <div className="flex flex-col items-center">
